 ...
 * sensor 2 (the middle one where velocity measurement starts)
...
void checkNotes(int midiNote) {
  ...
  checkNote(midiNote, digitalReadFast(note1_2) == LOW);
  checkNote(midiNote + 1, digitalReadFast(note2_2) == LOW);
  checkNote(midiNote + 2, digitalReadFast(note3_2) == LOW);
  checkNote(midiNote + 3, digitalReadFast(note4_2) == LOW);
  checkNote(midiNote + 4, digitalReadFast(note5_2) == LOW);
}
